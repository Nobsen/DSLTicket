    ...
    for (final TicketCategory category : categories) {
      {
        ...
        String _plus_6 = (_lowerCase + "/create.jsp");
        CharSequence _createJsp = JspGenerator.toCreateJsp(category);
        fsa.generateFile(_plus_6, TicketsOutputConfigurationProvider.JSP_OUTPUT, _createJsp);
        String _name_4 = category.getName();
        String _lowerCase_1 = _name_4.toLowerCase();
        String _plus_7 = (_lowerCase_1 + "/show.jsp");
        CharSequence _showJsp = JspGenerator.toShowJsp(category);
        fsa.generateFile(_plus_7, TicketsOutputConfigurationProvider.JSP_OUTPUT, _showJsp);
        String _name_5 = category.getName();
        String _lowerCase_2 = _name_5.toLowerCase();
        String _plus_8 = (_lowerCase_2 + "/list.jsp");
